...
DROP TABLE IF EXISTS ISCRITTO_R_PUNTEGGIO_SCU CASCADE;
...
ALTER TABLE ISCRITTO_R_PUNTEGGIO_DOM
	ADD  PRIMARY KEY (id_domanda_iscrizione,id_condizione_punteggio,dt_inizio_validita);
...
(
	...
	fl_ammissione_dis    VARCHAR(1) NULL
);
...
(
	...
	note                 TEXT NULL ,
	id_utente_ins            INTEGER NULL ,
	id_utente_mod            INTEGER NULL ,
...
CREATE TABLE ISCRITTO_R_PUNTEGGIO_SCU
(
	punti_scuola         INTEGER NOT NULL ,
	dt_inizio_validita   TIMESTAMP NOT NULL ,
	dt_fine_validita     TIMESTAMP NULL ,
...
ALTER TABLE ISCRITTO_R_PUNTEGGIO_SCU
	ADD  PRIMARY KEY (id_punteggio,id_scuola);
...
ALTER TABLE ISCRITTO_T_DOMANDA_ISC
	ADD FOREIGN KEY (id_utente_ins) REFERENCES ISCRITTO_T_UTENTE (id_utente) ON DELETE SET NULL;

ALTER TABLE ISCRITTO_T_DOMANDA_ISC
	ADD FOREIGN KEY (id_utente_mod) REFERENCES ISCRITTO_T_UTENTE (id_utente) ON DELETE SET NULL;
