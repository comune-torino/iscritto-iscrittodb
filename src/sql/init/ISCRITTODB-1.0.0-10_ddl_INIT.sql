...
(
	...
	fl_genitore2_pre_nuc    VARCHAR(1) NULL,
...
(
	...
	d_variazione          TIMESTAMP NULL ,
	d_appuntamento        TIMESTAMP NULL ,
...
ALTER TABLE iscritto.iscritto_r_scuola_pre ALTER COLUMN punteggio DROP NOT NULL;